...
def parse_args():
	...
	parser.add_argument('--image_paths', dest='image_paths', help='file containing image paths',
						default='/home/sihuili01/CVproject/drnet_cvpr2017/tools/reltest.json', type=str)

	parser.add_argument('--gpu', dest='gpu_id', help='GPU id to use',
						default=0, type=int)
	parser.add_argument('--def', dest='prototxt',
						help='prototxt file defining the network',
						default="/home/sihuili01/CVproject/drnet_cvpr2017/prototxts/test_drnet_8units_softmax.prototxt", type=str)
	parser.add_argument('--net', dest='caffemodel',
						help='model to test',
						default="/home/sihuili01/CVproject/drnet_cvpr2017/snapshots/drnet_8units_softmax.caffemodel", type=str)
...
def test_net(net, image_paths, args):
	...
	for i in range(num_img):
		...
		im = cv2.imread(image_paths[i]["imPath"]).astype(np.float32, copy=False)
		ih = im.shape[0]
		iw = im.shape[1]
		# gts = all_gts[i]
